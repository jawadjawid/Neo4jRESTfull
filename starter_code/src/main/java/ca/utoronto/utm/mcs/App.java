...
import ca.utoronto.utm.mcs.API.BaconAPI;
...
App
{
    ...
    public static void Initialize(){
        ...
        server.createContext("/api/v1/computeBaconNumber", new BaconAPI());
        server.createContext("/api/v1/computeBaconPath", new BaconAPI());
    }
